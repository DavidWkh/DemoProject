...
public class RegisterForm extends ActionForm {
	...
	public RegisterForm(String firstname, String middlename, String lastname, String user_id, String password,
			String dateofbirth, String gender, String email, String address, String postcode, String city,
			ArrayList<CityData> citylist, String state, ArrayList<StateData> statelist, String country, String action) {
		super();
